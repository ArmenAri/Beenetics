...
public class IconLoader {
	...
	public static ByteBuffer[] load(String filepath) {
		return load(IconLoader.class.getResourceAsStream(filepath));
	}
	 ...
	 *************************************************************************/
	public static ByteBuffer[] load(InputStream loader) {
	...
	/*************************************************************************
	 * Gets the width/height ratio of the icon. This is meant to simplify scaling
	 * the icon to a new dimension.
	 *
	 * @param src
